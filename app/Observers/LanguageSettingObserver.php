...
class LanguageSettingObserver
{
    ...
    public function detail($languageId)
    {
        ...
        $trFrontDetail->teamates_title = 'Manage All Bills';
        $trFrontDetail->teamates_detail = 'Automate billing and revenue recognition to streamline the contract-to-cash cycle.';
    ...
    public function testimonials($languageId)
    {
        $testimonials = [
            ...
            [
                'name' => 'angela whatson',
                'language_setting_id' => $languageId,
                'comment' => 'I am impressed by the features offered by the application.',
                'rating' => 4
            ],
            [
                'name' => 'whatson angela',
