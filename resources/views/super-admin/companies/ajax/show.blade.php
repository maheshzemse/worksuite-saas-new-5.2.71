                    ...
                    <div class="card-horizontal align-items-center">
                        ...
                        <div class="card-body border-0 pl-0">
                            ...
                            <p class="card-text f-11 text-lightest mb-0">@lang('app.createdOn') :
                                {{ $company->created_at->timezone(global_setting()->timezone)->format(global_setting()->date_format . ' ' . global_setting()->time_format) }}
                            </p>
                            <p class="card-text f-11 text-lightest">@lang('app.lastLogin')

                                @if (!is_null($company->last_login))
                                    {{ $company->last_login->timezone(global_setting()->timezone)->format(global_setting()->date_format . ' ' . global_setting()->time_format) }}
                                @else
                                    --
                                @endif
                            </p>
        ...
        @if($company->user)
            <x-cards.user :image="$company->user->image_url">
                ...
                <p class="f-13 font-weight-normal text-dark-grey mb-1">
                    {{ mb_ucwords($company->user->employeeDetail->company_name) }}
                </p>
